    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .PrimaryKey(t => new { t.TournamentId, t.AttendeeId })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Attendances", "TournamentId", "dbo.Tournaments");
            DropForeignKey("dbo.Attendances", "AttendeeId", "dbo.AspNetUsers");
            DropForeignKey("dbo.UserNotifications", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.UserNotifications", "NotificationId", "dbo.Notifications");
            DropForeignKey("dbo.Notifications", "Tournament_Id", "dbo.Tournaments");
            DropForeignKey("dbo.Tournaments", "MemberId", "dbo.AspNetUsers");
            ...
            DropIndex("dbo.Tournaments", new[] { "MemberId" });
            ...
            DropIndex("dbo.Attendances", new[] { "TournamentId" });
